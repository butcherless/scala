...
object CryptoCurrency {
  ...
  def validate(name: String, marketCap: BigDecimal, price: BigDecimal): ValidationNel[ValidationError, CryptoCurrency] =
    (checkName(name) |@|
...
object Factory {
  ...
  def newOptionCrytoCurrency(name: String, marketCap: BigDecimal, price: BigDecimal): Option[CryptoCurrency] = {
  ...
  def newTryCrytoCurrency(name: String, marketCap: BigDecimal, price: BigDecimal): Try[CryptoCurrency] = {
    // TODO validation NEL
